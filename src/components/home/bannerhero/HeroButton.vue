<template>
  <div class="text-center mt-12">
    <button
      class="font-medium focus:outline-none focus:ring-offset-black text-sm shadow-sm u-text-white bg-gradient-to-tr from-[#1a62ff] hover:bg-red-500 to-pink-500 transition-colors inline-flex items-center !p-[2px] !rounded-lg"
      type="button"
    >
      <span
